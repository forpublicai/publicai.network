...
description: How to contribute to publicai.network and who is involved in the Public AI Network.
permalink: /contributing/
---

## Start here

**Everyone can propose changes** to this site—no permission needed.

| Path | What to do |
|------|------------|
| **GitHub** | Open the [repository](https://github.com/forpublicai/publicai.network), edit a file, open a **pull request**. |
| **Slack** | Message `@Cursor` with the change you want (for example: add an event, fix a link, add your name). |
| **Ask** | [Open an issue](https://github.com/forpublicai/publicai.network/issues), post in Slack, or email [hello@publicai.network](mailto:hello@publicai.network). |

**Good first edits:** typos, [events on the homepage](/#events), [publications](/publications/), add yourself to the **Contributors** list below, or [news](/news/).
...
<details>
<summary><strong>GitHub vocabulary</strong> (PR, fork, merge, …)</summary>
...
<details>
<summary><strong>Why contribute?</strong></summary>
...
<details>
<summary><strong>What happens after I open a PR?</strong></summary>
...
<details>
<summary><strong>Site structure (for editors)</strong></summary>
...
<details>
<summary><strong>Slack: quick approvals</strong></summary>
