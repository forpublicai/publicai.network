...
summary: Co-lead the invite-only Public AI Seminar—speaker outreach, member recruitment, and session operations—for Season 4 and beyond.
---
...
- **Shape the theme** and update the [seminar page on GitHub](https://github.com/forpublicai/publicai.network/blob/main/seminar.md).
...
- **Run logistics**: application deadlines, [researchseminars.org](https://researchseminars.org/seminar/PublicAI), repeating calendar events with a consistent Zoom link, member announcements, Slack, and suggested readings.
...
To apply, send a brief note on your background and interest to [hello@publicai.network](mailto:hello@publicai.network).
